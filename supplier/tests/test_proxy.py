...
def test_supplier_public_api_view_bad_signature(mock_test_signature, client):
...
@patch('ui.signature.external_api_checker.test_signature')
def test_supplier_public_api_view_rejects_unsafe_methods(
...
def test_supplier_public_api_view_accepts_get(
